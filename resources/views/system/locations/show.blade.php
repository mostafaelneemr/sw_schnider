    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" cx="12" cy="21" r="1"/>
                    ...
                    <div class="d-flex align-items-center flex-wrap justify-content-between">
                        <!--begin::Description-->
                        <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5"> {{$result->description}}</div>
                        <!--end::Description-->
                        <!--begin::Progress-->
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                    ...
                    <div class="d-flex flex-column text-dark-75">
                        <span class="font-weight-bolder font-size-sm">{{__('Permission')}}</span>
...
{{$result->permission_group->name}}
                ...
                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                    ...
                    <div class="d-flex flex-column flex-lg-fill">
                        <span class="text-dark-75 font-weight-bolder font-size-sm">{{__('Nationality ID')}}</span>
                        <span class="font-weight-bolder font-size-h5">{{$result->national_id}}</span>
                    </div>
                </div>
                <!--end: Item-->
                <!--begin: Item-->
                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                    ...
                    <div class="d-flex flex-column">
                        <span class="text-dark-75 font-weight-bolder font-size-sm">{{__('Birth Date')}}</span>
                        <span class="font-weight-bolder font-size-h5">{{$result->birth_date}}</span>
                    </div>
                </div>
                <!--end: Item-->
                <!--begin: Item-->
