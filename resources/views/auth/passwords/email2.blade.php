                ...
                @endif
                    ...
                    <!--begin::Form-->
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-danger' : '' }}">
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="email" placeholder="Email" name="email" autocomplete="off" value="{{old('email')}}" required="required" />
                        </div>
                        ...
                        <div class="form-group d-flex flex-wrap flex-center pb-lg-0">
                            ...
                            <a type="button" href="{{route('login')}}" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Back Login</a>
                        </div>
                        <!--end::Form group-->
                    </form>
                    <!--end::Form-->
